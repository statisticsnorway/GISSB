...
# source("C:/Users/rdn/Documents/Kart/GiSSB/address_to_coord.R", encoding = "UTF-8")
...
```{r, eval=TRUE}
fra <- GISSB::address_to_coord(zip_code = "0177",
                         address = "Akersveien 26")

fra

til <- GISSB::address_to_coord(zip_code = "2211",
...
For å få koordinatene med CRS 4326 må dette spesifiseres i funksjonen `address_to_coord`. Det er også mulig å angi en vektor med flere postnummere og adresser for å få koordinatene til flere adresser:

```{r, eval=TRUE}
postnummere = c("0177", "2211")
adresser = c("Akersveien 26", "Otervegen 23")

fra_4326 <- GISSB::address_to_coord(zip_code = postnummere,
                         address = adresser,
                         crs_out = 4326)
fra_4326
```
...
til <- GISSB::address_to_coord(zip_code = postnummere,
                         address = adresser) %>%
  GISSB::coords_to_google()
to_node <- GISSB::coords_to_node(coords = til, direction = "to", membership = F)

fra <- GISSB::address_to_coord(zip_code = c("0177", "2211"),
